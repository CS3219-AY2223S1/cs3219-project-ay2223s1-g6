...
const URI_MATCH_SVC = process.env.URI_MATCH_SVC || 'http://localhost:9000';
...
const URI_EDITOR_SVC = process.env.URI_EDITOR_SVC || 'http://localhost:9000';
...
const URI_CHAT_SVC = process.env.URI_CHAT_SVC || 'http://localhost:9000';
