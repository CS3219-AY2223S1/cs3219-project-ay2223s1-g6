...
const URI_MATCHING_SVC = process.env.URI_MATCHING_SVC || 'http://localhost:9000';
...
export const URL_EDITOR_SVC = process.env.URI_EDITOR_SVC || 'http://localhost:9000';
export const EDITOR_SVC_SOCKETIO_PATH = '/api/editor/socket.io/';

export const URL_CHAT_SVC = process.env.URI_CHAT_SVC || 'http://localhost:9000';
